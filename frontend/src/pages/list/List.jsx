...
const List = () => {
  ...
  const {data, loading, error, reFetch} = useFetch(`/api/hotel/find?city=${destination}&minPrice=${min || 1}&maxPrice=${max || 999}`)
  // console.log('/api/hotel/find' + (destination !== '' ? `?city=${destination}` : ''))
  // console.log(data)
  const handleClick = () => {
    reFetch()
  }
